...
![Mantine](https://img.shields.io/badge/Mantine%20UI-339AF0?style=for-the-badge)
...
![Go](https://img.shields.io/badge/Go%201.26-00ADD8?style=for-the-badge&logo=go&logoColor=white)
...
### Tooling
![Yarn Berry](https://img.shields.io/badge/Yarn%204%20Berry-2C8EBB?style=for-the-badge&logo=yarn&logoColor=white)
![Monorepo](https://img.shields.io/badge/Monorepo-111827?style=for-the-badge)
![ESLint](https://img.shields.io/badge/ESLint%209-4B32C3?style=for-the-badge&logo=eslint&logoColor=white)
![Prettier](https://img.shields.io/badge/Prettier%203-F7B93E?style=for-the-badge&logo=prettier&logoColor=black)
![Jest](https://img.shields.io/badge/Jest%2029-C21325?style=for-the-badge&logo=jest&logoColor=white)
...
- Tiptap 3, Vitest 4, React Testing Library
...
- Kafka (KRaft), Socket.IO gateway
- Passport JWT + OAuth + MFA
- Stripe, AWS S3 SDK, Nodemailer, Sharp
...
- Yarn Berry 4 (PnP), Workspaces monorepo
- ESLint, Prettier, strict TypeScript
- Mailpit, MinIO, Kafka UI

### ☁️ Cloud & Infrastructure
- AWS: EC2, S3, Lambda, API Gateway, DynamoDB
- Cloudflare Images, Cloudflare Stream
- Vercel, Heroku, Render.com

### 🧩 Architecture
- Microservices: `backend` · `payment-service` · `file-service`
- Shared contracts package for HTTP + Kafka DTOs
